...
export function ServicesSection() {
  ...
  return (
    <section className="w-full py-32 bg-white text-neutral-900 overflow-hidden relative">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-24 gap-8">
          <div className="max-w-xl">
            ...
            <motion.h2
              ...
              className="font-serif text-4xl md:text-5xl text-neutral-900 leading-tight"
            >
          ...
          <motion.div
            ...
            className="w-full md:w-auto text-left md:text-right font-sans text-neutral-500 text-sm max-w-sm"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-4 lg:gap-8">
          {services.map((service, i) => (
            <motion.div
              ...
              className="flex flex-col items-start p-8 rounded-2xl bg-[#FCFAF5] border border-[#C9A84C]/15 shadow-[0_20px_40px_rgba(201,168,76,0.03)] hover:shadow-[0_20px_40px_rgba(201,168,76,0.08)] transition-all duration-300 transform hover:-translate-y-1 relative group"
            >
              ...
              <div className="w-14 h-14 rounded-full bg-white border border-[#C9A84C]/20 flex items-center justify-center mb-8 shrink-0 relative overflow-hidden shadow-sm">
              ...
              <h3 className="font-serif text-2xl text-neutral-900 mb-4">{service.title}</h3>
              <p className="font-sans text-neutral-600 text-[15px] leading-loose">{service.desc}</p>
            </motion.div>
          ))}
        </div>
      </div>
